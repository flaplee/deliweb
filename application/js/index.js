                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            if (res.code == 0) {
                                ...
                                while (i <= 5) {
                                    var item_shot = eval("screen_shot" + i),
                                        $targetHtml;
                ...
                var getDeviceAndOrg = function (appid, orgid, callback) {
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            if (res.code == 0) {
                                var app_device = res.data['result'].unbind_devices,
                                    targetHtml = '';
                                ...
                                var organization = res.data['result'].organization,
                                    targetOrgHtml = '',
                                    targetUserHtml = '',
                                    innerOrgHtml = '',
                                    innerUserHtml = '';
                                ...
                                var t = innerOrgHtml + targetOrgHtml,
                                    u = innerUserHtml + targetUserHtml;
